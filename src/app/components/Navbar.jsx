  ...
  return (
    <div className="flex min-h-screen bg-gray-100">
      ...
      <motion.aside
        ...
        className="w-[280px] bg-white text-gray-800 flex flex-col p-6 shadow-2xl rounded-r-2xl border-r border-gray-200"
      >
        {/* Dashboard */}
        <div>
          <button
          ...
          {openMenu === "dashboard" && (
            <div className="ml-6 mt-2 flex flex-col gap-2">
              <button
                ...
                className={`px-4 py-2 rounded flex items-center gap-2 ${viewType === "Regular"
              ...
              <button
                ...
                className={`px-4 py-2 rounded flex items-center gap-2 ${viewType === "Loan"
                    ? "bg-blue-600 text-white"
                    : "hover:bg-gray-100"
                  }`}
              >
        ...
        <div className="mt-3">
          ...
          {openMenu === "admin" && (
            <div className="ml-6 mt-2 flex flex-col gap-2">
              ...
              <div className=" px-4 py-2 rounded flex items-center gap-2 hover:bg-gray-100">
